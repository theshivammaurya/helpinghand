...
if(isset($_POST['btndonorregister']))
{
	...
	// $cpassword= $_POST['donorcpassword'];
    // // $email= $_POST['donoremailid'];
if ( $_POST[donornpassword] !== $_POST[donorcpassword])
{
	echo "<script>alert('Confirm Password Doesn't Matched..');</script>";
}
//  $emailQuery= "Select * from donor WHERE email_id=? LIMIT 1";


	$sql ="INSERT INTO donor(name,email_id,password,cpassword,contact_no,status) VALUES ('$_POST[name]','$_POST[donoremailid]','$_POST[donornpassword]','$_POST[donorcpassword]','$_POST[contactno]','Active')";
...
<li class="has-dropdown"><a href="#">Donate</a>
	<ul class="dropdown">
		<li><a href="fooddonor.php">Donate Items</a></li>
		<li><a href="viewfooddonor.php">Donated Items Report</a></li>
	</ul>
</li>
...
<li class="has-dropdown"><a href="#">Report</a>
	<ul class="dropdown">
		...
		<li><a href="viewfooddonor.php" >View item Donor</a></li>
