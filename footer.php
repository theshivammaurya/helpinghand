...
<form method="post" action="" onsubmit="return validateform2()">
	<div class="modal-dialog">
		  ...
		  <div class="modal-content">
			<div class="modal-header">
			  <button type="button" class="close" data-dismiss="modal">&times;</button>
			  <h4 class="modal-title">Donor Register </h4>
			</div>
...
<p>Helping Hands is the non-profit organization which helps old people, poor peopless which is situated in Varanasi, UttarPradesh.</p>
</div>
</div>
...
<li><i class="fa fa-map-marker"></i>Helping Hands,<br> &nbsp;&nbsp;&nbsp; Cantt.  Varanasi,<br> &nbsp;&nbsp;&nbsp; UttarPradesh-221002</li>
<li><i class="fa fa-phone"></i> 0542-2287236</li>
<li><i class="fa fa-envelope"></i> <a href="#"><span class="__cf_email__" data-cfemail="8fcce7eefde6fbf6cfeae2eee6e3a1ece0e2">HelpingHands@gmail.com</span></a></li>
</ul>
...
<span>
Copyright &copy;<script data-cfasync="false" src="scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script type="7909e31ca7813c4694085191-text/javascript">document.write(new Date().getFullYear());</script>  | developed by Helping Hand team.
</span>
</div>
</div>
</div>
