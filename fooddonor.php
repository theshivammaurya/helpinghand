...
<div class="media-body">
	...
	<h4> Donate Items Like - </h4>
	 <h5> Clothes, Footwear, Toys, Stationary items, Households, Furniture, Electronics items, Dry Ration etc..</h5>
	</div>
	<p>
...
<div class="row">
	...
	<div class="col-md-10">
		<textarea name="food_item_detail"  id="food_item_detail" class="form-control" rows="6"  >Enter item name &emsp;   &emsp;Quantity (in Units, kg)
		<?php echo $rsedit[food_item_detail]; ?></textarea>
...
<br>
<div class="row">
	<div class="col-md-2" style="padding-top: 5px;">Total Quantity </div>
	<div class="col-md-10">
...
function validateform()
{
	...
	{
		document.getElementById("errfood_item_detail").innerHTML = "Items detail should not be empty..";
		i=1;
	}
