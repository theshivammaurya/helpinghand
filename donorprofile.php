...
<div class="row">
	...
	<div class="col-md-10">
		<input type="text" name="name"  id="name" class="form-control"  value="<?php echo $rsedit[name]; ?>"required>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-10">
		<textarea name="address" id="address" class="form-control"required><?php echo $rsedit[address]; ?></textarea>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-10">
		<input type="text" name="city"  id="city" class="form-control" value="<?php echo $rsedit[city]; ?>"required>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-10">
		<input type="text" name="pin_code"  id="pin_code" class="form-control" value="<?php echo $rsedit[pin_code]; ?>"required>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-10">
		<input type="email" name="email_id"  id="email_id" class="form-control"  value="<?php echo $rsedit[email_id]; ?>"required>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-10">
		<input type="text" name="contact_no"  id="contact_no" class="form-control" value="<?php echo $rsedit[contact_no]; ?>"required>
	</div>
</div>
